...
class ModelArguments:
    ...
    forward_loss_weight: float = field(default=0.1)
    inverse_loss_weight: float = field(default=0.1)
    gen_loss_weight: float = field(default=0.1)
    vggt_features_path: str = field(default=None, metadata={"help": "Path to precomputed VGGT features (.pt file)"})
